# Figure 12c: Temperature field Ra=10^3
...
| :--- | :--- | :--- |
| `TRa3.png` | High-resolution image export. | PNG Image |
| `TRa3.fig` | Original source file (Editable in MATLAB). | MATLAB Figure |

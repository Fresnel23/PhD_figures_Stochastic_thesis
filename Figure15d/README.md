# Figure 15d: Comparison between MISA and FVM, temperature field
...
| :--- | :--- | :--- |
| `T_0.5.png` | High-resolution image export. | PNG Image |
| `T_0.5.fig` | Original source file (Editable in MATLAB). | MATLAB Figure |

# Figure 14b: Vertical velocity Ra=10^5
...
| :--- | :--- | :--- |
| `Ra5Vx.png` | High-resolution image export. | PNG Image |
| `Ra5Vx.fig` | Original source file (Editable in MATLAB). | MATLAB Figure |

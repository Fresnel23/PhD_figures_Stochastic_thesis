# Figura 12a: Stream functions compared both numerical schemes Ra=10^5
...
### 📊 Display
![Imagen Ra5_current](Ra5_current.png)
...
| :--- | :--- | :--- |
| `Ra5_current.png` | High-resolution image export. | PNG Image |
| `Ra5_current.fig` | Original source file (Editable in MATLAB). | MATLAB Figure |

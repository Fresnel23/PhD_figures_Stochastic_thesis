# Figura 12d: Stream functions compared both numerical schemes Ra=10^3
...
| :--- | :--- | :--- |
| `Ra3_current.png` | High-resolution image export. | PNG Image |
| `Ra3_current.fig` | Original source file (Editable in MATLAB). | MATLAB Figure |

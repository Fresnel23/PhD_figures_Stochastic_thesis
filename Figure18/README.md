...
### 📊 Display
![Imagen tiempos_computo](tiempos_computo.png)
...
| :--- | :--- | :--- |
| `tiempos_computo.png` | High-resolution image export. | PNG Image |
| `tiempos_computo.fig` | Original source file (Editable in MATLAB). | MATLAB Figure |
